...
public final class BotSpawnPrepareEvent extends BotEvent implements Cancellable {
    ...
    public BotSpawnPrepareEvent(
            long sequence, UUID ownerUUID, UUID botUUID, BotEventSource source, Location spawnLocation) {
        super(sequence, ownerUUID, botUUID, source, null);
        this.spawnLocation =
                Objects.requireNonNull(spawnLocation, "spawnLocation").clone();
    }
