...
class UltimateBotEventBusTest {
    ...
    void receivesFilteredSseEnvelope() throws Exception {
        ...
        server.createContext("/ultimatebot/api/v1/events", exchange -> {
        ...
        try (UltimateBotClient client = UltimateBotClient.builder()
                .baseUri("http://127.0.0.1:" + server.getAddress().getPort() + "/ultimatebot/api/v1/")
                .token("secret")
                .build()) {
