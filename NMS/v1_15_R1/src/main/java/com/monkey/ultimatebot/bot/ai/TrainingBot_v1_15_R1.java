...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_15_R1.EmptyNetworkManager;
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_15_R1.VersionedBotCraftPlayer;
...
public final class TrainingBot_v1_15_R1 extends EntityPlayer {
    ...
    public void applySwimState(boolean swimming) {
        ...
        if (swimming) {
            ...
            this.inWater = false;
            if (getPose() == EntityPose.SWIMMING) {
    ...
    private boolean isWaterBlock(net.minecraft.server.v1_15_R1.BlockPosition pos) {
        net.minecraft.server.v1_15_R1.IBlockData data = this.world.getType(pos);
        return data.getMaterial() == net.minecraft.server.v1_15_R1.Material.WATER
                || data.getBlock() == net.minecraft.server.v1_15_R1.Blocks.BUBBLE_COLUMN;
    }
    ...
    private boolean isInCobweb() {
        net.minecraft.server.v1_15_R1.BlockPosition feet =
                new net.minecraft.server.v1_15_R1.BlockPosition(this.locX(), this.locY(), this.locZ());
        net.minecraft.server.v1_15_R1.BlockPosition head = feet.up();
        return this.world.getType(feet).getBlock() == net.minecraft.server.v1_15_R1.Blocks.COBWEB
                || this.world.getType(head).getBlock() == net.minecraft.server.v1_15_R1.Blocks.COBWEB;
    }
