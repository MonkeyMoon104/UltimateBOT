...
/**
 * Real bot runtime for Spigot 1.12.2 ({@code v1_12_R1}).
 *
...
public final class NMSBridge_v1_12_R1 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_12_R1 entity =
                new TrainingBot_v1_12_R1(
                        server,
                        world,
    ...
    public boolean useItemOnBlock(
        ...
        // Fake-player interact often cancels; place directly like modern bridges' fallback.
