...
/**
 * Real bot runtime for Spigot 1.16.1 ({@code v1_16_R1}).
 *
...
public final class NMSBridge_v1_16_R1 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_16_R1 entity =
                new TrainingBot_v1_16_R1(
                        server,
                        world,
    ...
    public boolean useItemOnBlock(
        ...
        // 1.16.1 has no silent setSlot — write inventory lists to skip ITEM_ARMOR_EQUIP_GENERIC.
    ...
    public void sendSpawnAndMeta(Player viewer, ITrainingBot bot) {
        ...
        handle.playerConnection.sendPacket(new PacketPlayOutEntity.PacketPlayOutEntityLook(nativeBot.getId(), yaw, pitch, nativeBot.isOnGround()));
    ...
    public void setBotItem(ITrainingBot bot, EquipmentSlotKind slot, @Nullable ItemStack stack) {
        ...
        // Hands: write NonNullList directly (no silent setSlot on 1.16.1). Armor still uses
        // setSlot so attribute modifiers apply.
