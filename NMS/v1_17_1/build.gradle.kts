...
dependencies {
    paperweight.paperDevBundle(libsCatalog.findVersion("paper-bundle-1_17_1").get().requiredVersion)
    compileOnly(project(":core"))
    compileOnly(project(":common"))
    // Paper 1.17 pulls Guava 21 whose classfile refs missing errorprone annotations; silence -Werror noise.
