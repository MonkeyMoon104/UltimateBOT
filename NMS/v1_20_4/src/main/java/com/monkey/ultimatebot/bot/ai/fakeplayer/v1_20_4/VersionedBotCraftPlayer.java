package com.monkey.ultimatebot.bot.ai.fakeplayer.v1_20_4;
...
/** Version-local Bukkit adapter; core BotCraftPlayer only links against unversioned CraftBukkit (1.20.5+). */
@NullUnmarked
