...
import com.monkey.ultimatebot.bot.ai.TrainingBotHandle_v1_9_R2;
import com.monkey.ultimatebot.bot.ai.TrainingBot_v1_9_R2;
...
public final class NMSBridge_v1_9_R2 implements INMSBridge {

    private static final Set<PlatformCapability> CAPABILITIES = PlatformCapability.through1_9();
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_9_R2 entity = new TrainingBot_v1_9_R2(
                server,
                world,
    ...
    private static void applyHandItemAttributes(EntityPlayer nativeBot, EnumItemSlot slot) {
        net.minecraft.server.v1_9_R2.ItemStack held = nativeBot.getEquipment(slot);
        if (held == null) {
            return;
        }
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_9_R2) {
            return ((TrainingBotHandle_v1_9_R2) bot).nativeEntity();
        }
