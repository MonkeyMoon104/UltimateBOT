...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_10_R1.EmptyNetworkManager;
...
/**
 * Minimal 1.10.2 fake {@link EntityPlayer}. AI state lives on {@link TrainingBotHandle_v1_10_R1}.
 *
 ...
 */
public final class TrainingBot_v1_10_R1 extends EntityPlayer {

    private final TrainingBotHandle_v1_10_R1 handle;
    private final UltimateBot plugin;
    private final int tickTaskId;
    private int lastBotTick = Integer.MIN_VALUE;

    public TrainingBot_v1_10_R1(
        ...
        this.handle =
                new TrainingBotHandle_v1_10_R1(
