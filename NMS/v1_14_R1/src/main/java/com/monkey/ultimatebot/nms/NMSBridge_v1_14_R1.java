...
public final class NMSBridge_v1_14_R1 implements INMSBridge {
    ...
    private void respawnPacketViewers(ITrainingBot bot) {
        ...
        Map<EquipmentSlot, ItemStack> equipment = currentEquipment(bot);
    ...
    private Map<EquipmentSlot, ItemStack> currentEquipment(ITrainingBot bot) {
        Map<EquipmentSlot, ItemStack> equipment =
                new java.util.EnumMap<EquipmentSlot, ItemStack>(EquipmentSlot.class);
