...
/**
 * Bukkit-facing handle for the 1.14.4 fake player.
 *
 * <p>Kept separate from {@link EntityPlayer} so Spigot-mapped methods do not clash with
 * {@link ITrainingBot}.
 */
public final class TrainingBotHandle_v1_14_R1 implements ITrainingBot {

    private final TrainingBot_v1_14_R1 entity;
    private final TrainingBotLogic logic;
    private final UltimateBot plugin;

    TrainingBotHandle_v1_14_R1(
