...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_14_R1.EmptyNetworkManager;
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_14_R1.VersionedBotCraftPlayer;
...
public final class TrainingBot_v1_14_R1 extends EntityPlayer {
    ...
    public void applySwimState(boolean swimming) {
        ...
        applyEntityPose(swimming ? EntityPose.SWIMMING : EntityPose.STANDING);
    }

    private void applyEntityPose(EntityPose pose) {
        Method setter = poseSetter();
        if (setter == null) {
            return;
        }
        try {
    ...
    private static volatile @Nullable Method poseSetter;

    private static @Nullable Method poseSetter() {
        Method cached = poseSetter;
        if (cached != null) {
            return cached;
        }
        ...
        while (type != null) {
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (method.getParameterCount() == 1
                        ...
                        && method.getParameterTypes()[0] == EntityPose.class) {
    ...
    private boolean isWaterBlock(net.minecraft.server.v1_14_R1.BlockPosition pos) {
        net.minecraft.server.v1_14_R1.IBlockData data = this.world.getType(pos);
        return data.getMaterial() == net.minecraft.server.v1_14_R1.Material.WATER
                || data.getBlock() == net.minecraft.server.v1_14_R1.Blocks.BUBBLE_COLUMN;
    }
    ...
    private boolean isInCobweb() {
        net.minecraft.server.v1_14_R1.BlockPosition feet =
                new net.minecraft.server.v1_14_R1.BlockPosition(this.locX, this.locY, this.locZ);
        net.minecraft.server.v1_14_R1.BlockPosition head = feet.up();
        return this.world.getType(feet).getBlock() == net.minecraft.server.v1_14_R1.Blocks.COBWEB
                || this.world.getType(head).getBlock() == net.minecraft.server.v1_14_R1.Blocks.COBWEB;
    }
