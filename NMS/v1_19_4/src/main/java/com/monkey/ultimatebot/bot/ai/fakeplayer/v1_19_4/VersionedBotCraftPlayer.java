package com.monkey.ultimatebot.bot.ai.fakeplayer.v1_19_4;
...
public final class VersionedBotCraftPlayer extends CraftHumanEntity implements org.bukkit.entity.Player {
    ...
    @Override
    public void sendMultiBlockChange(java.util.Map<? extends io.papermc.paper.math.Position, org.bukkit.block.data.BlockData> arg0, boolean arg1) {
    }
    @Override
    ...
    @Override
        ...
        handle.yBodyRot = yaw;
        if (!(handle.getLevel() instanceof net.minecraft.server.level.ServerLevel)) {
            return;
        }
        net.minecraft.server.level.ServerLevel level = (net.minecraft.server.level.ServerLevel) handle.getLevel();
        ...
        net.minecraft.network.protocol.game.ClientboundRotateHeadPacket headPacket =
                new net.minecraft.network.protocol.game.ClientboundRotateHeadPacket(handle, head);
        net.minecraft.network.protocol.game.ClientboundMoveEntityPacket.Rot rotPacket =
                new net.minecraft.network.protocol.game.ClientboundMoveEntityPacket.Rot(
                        handle.getId(), body, xRot, handle.isOnGround());
