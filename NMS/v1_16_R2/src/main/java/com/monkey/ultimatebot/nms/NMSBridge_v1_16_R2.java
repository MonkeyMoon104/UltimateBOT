...
import com.monkey.ultimatebot.bot.ai.TrainingBotHandle_v1_16_R2;
import com.monkey.ultimatebot.bot.ai.TrainingBot_v1_16_R2;
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_16_R2.VersionedTntMinecart;
...
public final class NMSBridge_v1_16_R2 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_16_R2 entity = new TrainingBot_v1_16_R2(
                server,
                world,
    ...
    public boolean useItemOnBlock(
        ...
        net.minecraft.server.v1_16_R2.ItemStack requested = CraftItemStack.asNMSCopy(stack);
        if (requested.isEmpty()) {
            return false;
        }
        net.minecraft.server.v1_16_R2.ItemStack held =
        ...
        ItemActionContext context = new ItemActionContext(nativeBot.world, nativeBot, enumHand, held, hitResult);
    ...
    public void sendEquipment(Player viewer, ITrainingBot bot, Map<EquipmentSlotKind, ItemStack> equipment) {
        List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack>> converted = toNmsEquipment(equipment);
    ...
    public void setBotItem(ITrainingBot bot, EquipmentSlotKind slot, @Nullable ItemStack stack) {
        ...
        net.minecraft.server.v1_16_R2.ItemStack nms = CraftItemStack.asNMSCopy(resolved);
    ...
    public void setExplosiveMinecartFuseTicks(Entity minecart, int ticks) {
        ...
        net.minecraft.server.v1_16_R2.Entity handle = ((CraftEntity) minecart).getHandle();
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_16_R2) {
            return ((TrainingBotHandle_v1_16_R2) bot).nativeEntity();
        }
    ...
    private static List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack>> toNmsEquipment(
            Map<EquipmentSlotKind, ItemStack> equipment) {
        List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack>> converted =
                new ArrayList<Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack>>();
