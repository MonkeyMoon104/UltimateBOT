...
/**
 * Real bot runtime for Spigot 1.16.3 ({@code v1_16_R2}).
 *
...
public final class NMSBridge_v1_16_R2 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_16_R2 entity =
                new TrainingBot_v1_16_R2(
                        server,
                        world,
    ...
    public boolean useItemOnBlock(
        ...
        // 1.16.3 has no silent setSlot — write inventory lists to skip ITEM_ARMOR_EQUIP_GENERIC.
    ...
    public void setBotItem(ITrainingBot bot, EquipmentSlot slot, @Nullable ItemStack stack) {
        ...
        // Hands: write NonNullList directly (no silent setSlot on 1.16.3). Armor still uses
