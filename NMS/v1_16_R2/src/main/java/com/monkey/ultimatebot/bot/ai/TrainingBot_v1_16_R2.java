...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_16_R2.EmptyNetworkManager;
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_16_R2.VersionedBotCraftPlayer;
...
public final class TrainingBot_v1_16_R2 extends EntityPlayer {
    ...
    private boolean isWaterBlock(net.minecraft.server.v1_16_R2.BlockPosition pos) {
        net.minecraft.server.v1_16_R2.IBlockData data = this.world.getType(pos);
        return data.getMaterial() == net.minecraft.server.v1_16_R2.Material.WATER
                || data.getBlock() == net.minecraft.server.v1_16_R2.Blocks.BUBBLE_COLUMN;
    }
    ...
    private boolean isInCobweb() {
        net.minecraft.server.v1_16_R2.BlockPosition feet =
                new net.minecraft.server.v1_16_R2.BlockPosition(this.locX(), this.locY(), this.locZ());
        net.minecraft.server.v1_16_R2.BlockPosition head = feet.up();
        return this.world.getType(feet).getBlock() == net.minecraft.server.v1_16_R2.Blocks.COBWEB
                || this.world.getType(head).getBlock() == net.minecraft.server.v1_16_R2.Blocks.COBWEB;
    }
