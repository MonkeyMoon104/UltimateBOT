...
import com.monkey.ultimatebot.bot.ai.TrainingBotHandle_v1_8_R2;
import com.monkey.ultimatebot.bot.ai.TrainingBot_v1_8_R2;
...
public final class NMSBridge_v1_8_R2 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_8_R2 entity = new TrainingBot_v1_8_R2(
                server,
                world,
    ...
    public ItemStack getBotItem(ITrainingBot bot, EquipmentSlotKind slot) {
        ...
        net.minecraft.server.v1_8_R2.ItemStack nms = nativeBot(bot).getEquipment(index.intValue());
    ...
    public void setBotItem(ITrainingBot bot, EquipmentSlotKind slot, @Nullable ItemStack stack) {
        ...
        net.minecraft.server.v1_8_R2.ItemStack nms = CraftItemStack.asNMSCopy(resolved);
        EntityPlayer nativeBot = nativeBot(bot);
    ...
    public void clearBotInventory(ITrainingBot bot) {
        EntityPlayer nativeBot = nativeBot(bot);
        nativeBot.inventory.items = new net.minecraft.server.v1_8_R2.ItemStack[36];
        nativeBot.inventory.armor = new net.minecraft.server.v1_8_R2.ItemStack[4];
    }
    ...
    private static void syncMainHandAttackAttributes(EntityPlayer nativeBot) {
        net.minecraft.server.v1_8_R2.ItemStack held = nativeBot.inventory.getItemInHand();
    ...
    private static void applyHeldItemAttributes(
            EntityPlayer nativeBot, net.minecraft.server.v1_8_R2.ItemStack stack, boolean add) {
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_8_R2) {
            return ((TrainingBotHandle_v1_8_R2) bot).nativeEntity();
        }
