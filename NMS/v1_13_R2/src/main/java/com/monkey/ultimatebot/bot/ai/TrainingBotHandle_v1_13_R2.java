...
/**
 * Bukkit-facing handle for the 1.13.2 fake player.
 *
 * <p>Kept separate from {@link EntityPlayer} so Spigot-mapped methods do not clash with
 * {@link ITrainingBot}.
 */
public final class TrainingBotHandle_v1_13_R2 implements ITrainingBot {

    private final TrainingBot_v1_13_R2 entity;
    private final TrainingBotLogic logic;
    private final UltimateBot plugin;

    TrainingBotHandle_v1_13_R2(
