...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_13_R2.EmptyNetworkManager;
...
public final class TrainingBot_v1_13_R2 extends EntityPlayer {
    ...
    private boolean isWaterBlock(BlockPosition pos) {
        ...
        return data.getMaterial() == Material.WATER || data.getBlock() == Blocks.BUBBLE_COLUMN;
    }
