package com.monkey.ultimatebot.bot.ai.fakeplayer.v1_19_3;
...
public final class VersionedBotCraftPlayer extends CraftHumanEntity implements org.bukkit.entity.Player {
    ...
    @Override
    public void sendMultiBlockChange(java.util.Map<org.bukkit.Location, org.bukkit.block.data.BlockData> arg0, boolean arg1) {
    }
    @Override
    ...
    @Override
    public void sendSignChange(org.bukkit.Location arg0, java.util.List<net.kyori.adventure.text.Component> arg1, org.bukkit.DyeColor arg2, boolean arg3) throws java.lang.IllegalArgumentException {
    }
    @Override
    ...
    @Override
        ...
        handle.yRotO = yaw;
        handle.xRotO = pitch;
        handle.yHeadRotO = yaw;
        handle.yBodyRotO = yaw;
        // Position/head packets are sent from TrainingBot_v1_19_3.tick (teleport). Rot packets
        // with sticky onGround fight the tracker and make follow look drift.
    }
    @Override
