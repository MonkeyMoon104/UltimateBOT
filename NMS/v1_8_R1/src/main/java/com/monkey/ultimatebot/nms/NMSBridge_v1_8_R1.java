...
public final class NMSBridge_v1_8_R1 implements INMSBridge {
    ...
    public ItemStack getBotItem(ITrainingBot bot, EquipmentSlotKind slot) {
        ...
        net.minecraft.server.v1_8_R1.ItemStack nms = nativeBot(bot).getEquipment(index.intValue());
    ...
    public void clearBotInventory(ITrainingBot bot) {
        EntityPlayer nativeBot = nativeBot(bot);
        nativeBot.inventory.items = new net.minecraft.server.v1_8_R1.ItemStack[36];
        nativeBot.inventory.armor = new net.minecraft.server.v1_8_R1.ItemStack[4];
    }
    ...
    private static void applyHeldItemAttributes(
            EntityPlayer nativeBot, net.minecraft.server.v1_8_R1.ItemStack stack, boolean add) {
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_8_R1) {
            return ((TrainingBotHandle_v1_8_R1) bot).nativeEntity();
        }
