...
ultimatebotPaperweight {
    catalog("paper-bundle-26_3")
}

val invui = extensions.getByType<VersionCatalogsExtension>().named("libs").findLibrary("invui-v2-5").get()
...
val relocateInvuiCompile = tasks.register<ShadowJar>("relocateInvuiCompile") {
    archiveFileName.set("invui-v2-5-relocated-compile.jar")
