...
public final class VersionedBotCraftPlayer extends CraftHumanEntity implements org.bukkit.entity.Player {
    ...
    public java.util.UUID getUniqueId() {
        // Avoid Entity#getUUID(): SpecialSource leaves the Mojang name, but Paper 1.17 expects
        // Spigot getUniqueID(). GameProfile#getId is authlib and stable across remaps.
