...
import com.monkey.ultimatebot.bot.ai.fakeplayer.v1_13_R1.EmptyNetworkManager;
...
/**
 * Minimal 1.13 fake {@link EntityPlayer}. AI state lives on {@link TrainingBotHandle_v1_13_R1}.
 *
 ...
 */
public final class TrainingBot_v1_13_R1 extends EntityPlayer {

    private final TrainingBotHandle_v1_13_R1 handle;
    private final UltimateBot plugin;

    public TrainingBot_v1_13_R1(
    ...
    private boolean isInCobweb() {
        ...
        return this.world.getType(feet).getBlock() == Blocks.COBWEB
                || this.world.getType(head).getBlock() == Blocks.COBWEB;
    }
