...
/**
 * Real bot runtime for Spigot 1.13 ({@code v1_13_R1}).
 *
...
public final class NMSBridge_v1_13_R1 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_13_R1 entity =
                new TrainingBot_v1_13_R1(
                        server,
                        world,
    ...
    public void setBotRotation(Player bot, float yaw, float pitch) {
        ...
        // EntityLiving body yaw field on this revision; avoid CraftEntityLookAccess float-on-int.
        nativeBot.aQ = yaw;
    ...
    public boolean useItemOnBlock(
        ...
        if (held.getItem() == Items.END_CRYSTAL && hasEndCrystalAbove(nativeBot, pos)) {
            // Already occupied — do not call Item.useOn (spams interact sound / place loop).
            return false;
        }
        ...
        // Prefer raw Item.useOn: ItemStack.placeItem wraps BlockPlaceEvent, often cancelled for fakes.
    ...
    private static boolean placeObsidianDirect(
            WorldServer world, BlockPosition clicked, EnumDirection face) {
    ...
    private static void restoreHeldCount(
            net.minecraft.server.v1_13_R1.ItemStack nmsStack, int previousCount) {
