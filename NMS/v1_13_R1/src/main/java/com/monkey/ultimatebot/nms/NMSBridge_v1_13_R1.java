...
import com.monkey.ultimatebot.bot.ai.TrainingBotHandle_v1_13_R1;
import com.monkey.ultimatebot.bot.ai.TrainingBot_v1_13_R1;
...
public final class NMSBridge_v1_13_R1 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_13_R1 entity = new TrainingBot_v1_13_R1(
                server,
                world,
    ...
    public boolean useItemOnBlock(
        ...
        net.minecraft.server.v1_13_R1.ItemStack requested = CraftItemStack.asNMSCopy(stack);
        if (requested.isEmpty()) {
            return false;
        }
        net.minecraft.server.v1_13_R1.ItemStack held =
        ...
        ItemActionContext context = new ItemActionContext(nativeBot, held, pos, direction, hitX, hitY, hitZ);
    ...
    private static boolean placeEndCrystalDirect(WorldServer world, EntityPlayer placer, BlockPosition clicked) {
        net.minecraft.server.v1_13_R1.IBlockData data = world.getType(clicked);
    ...
    private static void setHeldSilently(
            EntityPlayer nativeBot, EnumHand hand, net.minecraft.server.v1_13_R1.ItemStack stack) {
    ...
    private static void restoreHeldCount(net.minecraft.server.v1_13_R1.ItemStack nmsStack, int previousCount) {
    ...
    private static void applyHandItemAttributes(EntityPlayer nativeBot, EnumItemSlot slot) {
        net.minecraft.server.v1_13_R1.ItemStack held = nativeBot.getEquipment(slot);
        if (held == null) {
            return;
        }
    ...
    public void attackEntity(ITrainingBot bot, org.bukkit.entity.Entity target) {
        EntityPlayer nativeBot = nativeBot(bot);
        applyHandItemAttributes(nativeBot, EnumItemSlot.MAINHAND);
        nativeBot.attack(((org.bukkit.craftbukkit.v1_13_R1.entity.CraftEntity) target).getHandle());
    }
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_13_R1) {
            return ((TrainingBotHandle_v1_13_R1) bot).nativeEntity();
        }
