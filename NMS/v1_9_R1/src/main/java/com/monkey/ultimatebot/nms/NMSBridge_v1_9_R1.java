...
import com.monkey.ultimatebot.bot.ai.TrainingBotHandle_v1_9_R1;
import com.monkey.ultimatebot.bot.ai.TrainingBot_v1_9_R1;
...
public final class NMSBridge_v1_9_R1 implements INMSBridge {
    ...
    public ITrainingBot createTrainingBot(
        ...
        TrainingBot_v1_9_R1 entity = new TrainingBot_v1_9_R1(
                server,
                world,
    ...
    private static void applyHandItemAttributes(EntityPlayer nativeBot, EnumItemSlot slot) {
        net.minecraft.server.v1_9_R1.ItemStack held = nativeBot.getEquipment(slot);
        if (held == null) {
            return;
        }
    ...
    private static EntityPlayer nativeBot(ITrainingBot bot) {
        if (bot instanceof TrainingBotHandle_v1_9_R1) {
            return ((TrainingBotHandle_v1_9_R1) bot).nativeEntity();
        }
