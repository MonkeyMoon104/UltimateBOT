package com.monkey.mcbot.gui.v26_1_2;

import com.monkey.mcbot.MinecraftBot;
import com.monkey.mcbot.bot.BotOptions;
import com.monkey.mcbot.bot.BotType;
import com.monkey.mcbot.bot.ai.ITrainingBot;
import com.monkey.mcbot.gui.v26_1_2.impl.BotTabItem;
import com.monkey.mcbot.gui.v26_1_2.tab.BotGuiTabContext;
import com.monkey.mcbot.gui.v26_1_2.tab.KitTab;
import com.monkey.mcbot.gui.v26_1_2.tab.OwnersTab;
import com.monkey.mcbot.gui.v26_1_2.tab.RankTab;
import com.monkey.mcbot.gui.v26_1_2.tab.TargetsTab;
...
public class NewBotGUI_v26_1_2 {

    private final Player player;
    private final MinecraftBot training;
    private final BotType botType;

    public NewBotGUI_v26_1_2(Player player, MinecraftBot training) {
        this(player, training, BotType.SINGLE);
    }

    public NewBotGUI_v26_1_2(Player player, MinecraftBot training, boolean isEventBot) {
        this(player, training, isEventBot ? BotType.EVENT : BotType.SINGLE);
    }

    public NewBotGUI_v26_1_2(Player player, MinecraftBot training, BotType botType) {
        this.player = player;
    ...
    public void open() {
        ...
        Gui tabGui = TabGui.builder()
                ...
                .setTabs(List.of(tab0, tab1, tab2, tab3))
                .build();
