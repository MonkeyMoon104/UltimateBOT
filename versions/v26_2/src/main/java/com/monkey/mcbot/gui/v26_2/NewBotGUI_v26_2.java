package com.monkey.mcbot.gui.v26_2;

import com.monkey.mcbot.MinecraftBot;
import com.monkey.mcbot.bot.BotOptions;
import com.monkey.mcbot.bot.BotType;
import com.monkey.mcbot.bot.ai.ITrainingBot;
import com.monkey.mcbot.gui.v26_2.impl.BotTabItem;
...
public class NewBotGUI_v26_2 {
    ...
    public NewBotGUI_v26_2(Player player, MinecraftBot training) {
        this(player, training, BotType.SINGLE);
    }

    public NewBotGUI_v26_2(Player player, MinecraftBot training, boolean isEventBot) {
        this(player, training, isEventBot ? BotType.EVENT : BotType.SINGLE);
    }

    public NewBotGUI_v26_2(Player player, MinecraftBot training, BotType botType) {
        this.player = player;
