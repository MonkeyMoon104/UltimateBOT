...
public class NewBotGUI_v26_2 {
    ...
    public NewBotGUI_v26_2(Player player, UltimateBot training) {
        this(player, training, BotType.SINGLE);
    }

    public NewBotGUI_v26_2(Player player, UltimateBot training, boolean isEventBot) {
        this(player, training, isEventBot ? BotType.EVENT : BotType.SINGLE);
    }

    public NewBotGUI_v26_2(Player player, UltimateBot training, BotType botType) {
        this.player = player;
