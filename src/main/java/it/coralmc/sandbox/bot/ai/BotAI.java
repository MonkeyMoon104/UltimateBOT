...
import it.coralmc.sandbox.bot.ai.handlers.helper.inter.ICombatStrategyExecutor;
import it.coralmc.sandbox.bot.ai.handlers.helper.inter.IPathfindingManager;
