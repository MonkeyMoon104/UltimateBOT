...
public final class BlockPlaceAccess {
    ...
    private static BlockPlaceEvent legacyEvent(Block block, BlockState replacedState, ItemStack stack, Player placer) {
    ...
    private static @Nullable Constructor<BlockPlaceEvent> resolveHandCtor() {
        try {
            ...
            return BlockPlaceEvent.class.getConstructor(
                    Block.class, BlockState.class, Block.class, ItemStack.class, Player.class, boolean.class, slot);
