...
public final class ModeCombatPolicy {
    private ModeCombatPolicy() {}

    public static boolean canLaunchMace(double horizontalDistance, boolean onGround, boolean specialActionReady) {
        return horizontalDistance <= 4.5D && onGround && specialActionReady;
    }

    public static boolean canFightInWater(boolean botInWater, boolean targetInWater) {
        return botInWater && targetInWater;
    }

    public static boolean isCartOpportunity(
    ...
    public static boolean shouldUsePotions(double healthRatio, double healingThreshold, boolean specialActionReady) {
        return healthRatio <= healingThreshold && specialActionReady;
    }

    public static boolean isIncomingPlayerAttack(
            double distance,
    ...
    public static boolean isSafeAxeOpening(
    ...
    public static boolean isBowFullyDrawn(int drawTicks) {
        return drawTicks >= 20;
    }
    ...
    public static int ignitionBowDrawTicks(double distance) {
