...
/**
 * Disallows arrow/trident pickup across Bukkit revisions.
 *
 * <p>1.14+ uses {@code AbstractArrow.PickupStatus}. 1.13 and earlier nest {@code PickupStatus} on
 * {@code Arrow}. Linking {@code AbstractArrow} in core crashes class resolution on 1.13.2 — resolve
 * by name instead.
 */
public final class ArrowPickupAccess {
    ...
    public static void disallowPickup(Projectile projectile) {
        ...
        try {
            ...
            // Visual/loot only — leave default pickup.
        }
    }
