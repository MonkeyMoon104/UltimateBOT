...
/**
 * Cross-version access to plugin name/version/authors.
 *
 * <p>{@code Plugin#getPluginMeta()} exists only on Paper 1.19.3+. Calling it directly produces
 * {@link NoSuchMethodError} on older Paper (including 1.17.1). This helper soft-reflects
 * {@code getPluginMeta} when present and otherwise falls back to {@link Plugin#getDescription()}.
 */
