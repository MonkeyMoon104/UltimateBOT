...
/**
 * Resolves {@link PotionEffectType} constants across Paper/Bukkit renames.
 *
 * <p>Examples: {@code STRENGTH}/{@code INCREASE_DAMAGE}, {@code INSTANT_HEALTH}/{@code HEAL},
 * {@code JUMP_BOOST}/{@code JUMP}. Hard references to the newer names throw {@link
 * NoSuchFieldError} on 1.20.4 and earlier.
 */
