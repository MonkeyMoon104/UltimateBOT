...
/**
 * Resolves {@link Enchantment} across Bukkit renames without linking {@code NamespacedKey}.
 *
 * <p>{@code org.bukkit.NamespacedKey} and {@link Enchantment#getByKey} exist from 1.12 / 1.13. Hard
 * references crash 1.11 with {@code NoClassDefFoundError} as soon as armor GUI applies Protection.
 */
public final class EnchantmentAccess {
    ...
    private static final @Nullable Method MINECRAFT_KEY =
            method(NAMESPACED_KEY, "minecraft", String.class);
    ...
    /**
     * Looks up an enchantment from a Minecraft key ({@code protection}) or a legacy Bukkit name
     * ({@code PROTECTION_ENVIRONMENTAL}).
     */
