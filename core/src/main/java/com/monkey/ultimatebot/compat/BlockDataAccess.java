...
/**
 * Block capture / restore / client updates without hard-linking {@code BlockData}.
 *
 * <p>{@link Block#getBlockData()} / {@link Block#setBlockData} and {@code Material#createBlockData}
 * are 1.13+. On older servers we snapshot {@link BlockState} and use legacy {@code sendBlockChange}.
 */
public final class BlockDataAccess {
    ...
    private static final @Nullable Method SEND_BLOCK_CHANGE_DATA =
            BLOCK_DATA_TYPE == null
                    ? null
                    : method(Player.class, "sendBlockChange", Location.class, BLOCK_DATA_TYPE);
    ...
    /** Snapshot of the block before mutation (BlockData on 1.13+, BlockState otherwise). */
    ...
    public static void restore(Block block, Object snapshot, boolean applyPhysics) {
        ...
        throw new IllegalArgumentException("Unsupported block snapshot: " + snapshot.getClass().getName());
    }
